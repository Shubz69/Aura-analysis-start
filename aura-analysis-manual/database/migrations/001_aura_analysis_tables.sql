-- Aura Analysis (FREE manual dashboard) - MySQL tables
-- Run this migration on your existing MySQL DB (Railway).
...
-- 6) Settings (key-value). JSON type requires MySQL 5.7.8+
